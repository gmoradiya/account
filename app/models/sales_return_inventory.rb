class SalesReturnInventory < ApplicationRecord
  ...
  belongs_to :sales_return_invoice
  belongs_to :product
  ...
  #   if invoiceable.nil?
  #     errors.add(:base, "Invoice link (Chalan) is required. You have to adjust quantity")
  #   end
  # end
